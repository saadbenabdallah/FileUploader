...
public class UploadController {
	...
	public ResponseEntity<String> handleFileUpload(
		...
		try {
			storageService.store(file, pathFile);
	...
	public ResponseEntity<List<String>> getListFiles(@RequestParam("pathFile") String pathFile) {
	...
	public ResponseEntity<Resource> getFile(
		...
		String pathFile ="C:/b2i/saad";
		Resource file = storageService.loadFile(filename, pathFile);
